...
from .bionic_arm_env_cfg import BionicArmEnvCfg


@configclass
class BionicArmVisionEnvCfg(BionicArmEnvCfg):
    # scene
...
@configclass
class BionicArmVisionEnvPlayCfg(BionicArmVisionEnvCfg):
    # scene
...
class BionicArmVisionEnv(InHandManipulationEnv):
    cfg: BionicArmVisionEnvCfg

    def __init__(self, cfg: BionicArmVisionEnvCfg, render_mode: str | None = None, **kwargs):
