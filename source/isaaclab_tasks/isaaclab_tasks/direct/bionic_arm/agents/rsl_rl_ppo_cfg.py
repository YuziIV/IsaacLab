...
@configclass
class BionicArmPPORunnerCfg(RslRlOnPolicyRunnerCfg):
...
@configclass
class BionicArmAsymFFPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 16
    max_iterations = 10000
    save_interval = 250
...
@configclass
class BionicArmVisionFFPPORunnerCfg(RslRlOnPolicyRunnerCfg):
